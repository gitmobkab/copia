...
class TestPositionals:
    ...
    def test_float_positional(self):
        ...
        assert result == [
            Column(None,
                   False,
                   GeneratorCall("float", Params([4.5], {})))
        ]
    ...
    def test_negative_int(self):
        ...
        assert result == [
            Column(None,
                   False,
                   GeneratorCall("int", Params([-10, 10], {})))
        ]
    ...
    def test_negative_float(self):
        ...
        assert result == [
            Column(None,
                   False,
                   GeneratorCall("float", Params([-1.5, 1.5], {})))
        ]
    ...
    def test_bool_positional_true(self):
        ...
        assert result == [
            Column(None,
                   False,
                   GeneratorCall("gen", Params([True, True], {})))
        ]
    ...
    def test_bool_positional_false(self):
        ...
        assert result == [
            Column(None,
                   False,
                   GeneratorCall("gen", Params([False, False], {})))
        ]
    ...
    def test_string_double_quoted(self):
        ...
        assert result == [
            Column(None,
                   False,
                   GeneratorCall("gen", Params(["hello"], {})))
        ]
